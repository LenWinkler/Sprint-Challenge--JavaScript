...
// const unsortedUnis = graduates.map(function(item){
//   return item.university;
// });

const unsortedUnis = graduates.map(item => item.university);

const universities = unsortedUnis.sort();
...
// const populationTotal = zooAnimals.reduce((accumulator, item) => accumulator + item.population); 0;   // returns "[object Object]18129510105"
