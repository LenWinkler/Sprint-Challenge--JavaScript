...
class NewCuboidMaker{
    constructor(makerAttrs){
    this.length = makerAttrs.length,
    this.width = makerAttrs.width,
    this.height = makerAttrs.height
  }
  volume(){
...
console.log(newCuboid.cubeVolume());
console.log(newCuboid.cubeSurfaceArea());